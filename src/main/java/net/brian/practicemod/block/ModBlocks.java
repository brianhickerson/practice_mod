package net.brian.practicemod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> FLESHBLOCK = BLOCKS.register("flesh_block",
            () ->new Block(BlockBehaviour.Properties.copy(Blocks.DIRT)));
    public static final RegistryObject<Block> SKINBLOCK = BLOCKS.register("skin_block",
